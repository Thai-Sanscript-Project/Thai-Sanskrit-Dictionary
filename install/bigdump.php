...
$filename           = 'dictionary-system.sql';     // Specify the dump filename to suppress the file selection dialog
...
if (!$error && !isset ($_REQUEST["fn"]) && $filename!="")
{ echo ("<br><br><p><a href=\"".$_SERVER["PHP_SELF"]."?start=1&amp;fn=".urlencode($filename)."&amp;foffset=0&amp;totalqueries=0\">".$lang_bigdump9."</a> ".$lang_installer3." $filename ".$lang_installer4." $db_name ".$lang_installer5." $db_server</p>\n");
}
...
// Print start message
  ...
  { skin_open();
    ...
    echo ("<p class=\"centr\">".$lang_installer10." <b>".$curfilename."</b></p>\n");
    echo ("<p class=\"smlcentr\">".$lang_installer11." ".$_REQUEST["start"]."</p>\n");	
    skin_close();
  }
...
// echo ("<p class=\"centr\"><b>Statistics</b></p>\n");
  ...
  { 
    ...
    <tr><th class=\"bg4\"> </th><th class=\"bg4\">Session</th><th class=\"bg4\">".$lang_bigdump2."</th><th class=\"bg4\">".$lang_bigdump3."</th><th class=\"bg4\">".$lang_bigdump4."</th></tr>
    <tr><th class=\"bg4\">".$lang_bigdump5."</th><td class=\"bg3\">$lines_this</td><td class=\"bg3\">$lines_done</td><td class=\"bg3\">$lines_togo</td><td class=\"bg3\">$lines_tota</td></tr>
    <tr><th class=\"bg4\">".$lang_bigdump6."</th><td class=\"bg3\">$queries_this</td><td class=\"bg3\">$queries_done</td><td class=\"bg3\">$queries_togo</td><td class=\"bg3\">$queries_tota</td></tr>
...
// Finish message and restart the script
    ...
    { echo ("<p class=\"successcentr\">".$lang_bigdump7."</p>\n");
      echo ("<p class=\"successcentr\">".$lang_bigdump8."</p>\n");
    ...
    { if ($delaypersession!=0)
      ...
      echo ("<p class=\"centr\">".$lang_installer6." <b><a href=\"".$_SERVER["PHP_SELF"]."\">".$lang_installer7."</a></b> ".$lang_installer8." <b>".$lang_installer9."</b></p>\n");
    }
  }
  else 
...
?>
<p class="centr">&copy; 2006-2011 Dictionary System</p>
