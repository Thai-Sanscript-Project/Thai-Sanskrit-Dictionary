...
$this->settings = array(
  ...
  'height'                  => '150',                                   // default height of the control; in pixels or %
  
  'required'                => true,                                   // if true form will not submit unless a file is selected 
                                                                        // for upload
  ...
  'useOriginalName'         => true,                                   // normally for security reasons Uploader stores files 
  ...
  'overwriteExisting'       => true,                                   // aplicable only if useoriginalname is set to true. 
  ...
  'language'                => $_SESSION["lang"],                                    // language for prompts
  ...
  'allowedExtensions'       => array('csv'),                            // an array of allowed file extensions
