...
<link rel="stylesheet" type="text/css" title="hvalur" href="style.php">	  
...
function setchar(ch) {
document.form1.search_string.value += ch;
document.form1.search_string.focus()
}
...
<script type='text/javascript' src='<?=$IMAGE_URL?>scripts/DropDown/dropdown/jquery.jgd.dropdown.js'></script>
</head>
